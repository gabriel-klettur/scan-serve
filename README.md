...
## Why This Project ExistsDigitizing physical receipts is a tedious, error-prone process. OCR alone isn't enough — raw text from a crumpled supermarket receipt is noisy, misordered, and missing context. You need **intelligent post-processing** to turn that into usable data.
